...
rentcast_market_statistics200_response_sale_data_history202410_instance = RentcastMarketStatistics200ResponseSaleDataHistory202410.from_json(json)
# print the JSON string representation of the object
print(RentcastMarketStatistics200ResponseSaleDataHistory202410.to_json())

# convert the object into a dict
rentcast_market_statistics200_response_sale_data_history202410_dict = rentcast_market_statistics200_response_sale_data_history202410_instance.to_dict()
# create an instance of RentcastMarketStatistics200ResponseSaleDataHistory202410 from a dict
rentcast_market_statistics200_response_sale_data_history202410_from_dict = RentcastMarketStatistics200ResponseSaleDataHistory202410.from_dict(rentcast_market_statistics200_response_sale_data_history202410_dict)
```
