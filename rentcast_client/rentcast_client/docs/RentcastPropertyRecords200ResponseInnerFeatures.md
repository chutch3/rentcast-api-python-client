...
**cooling** | **bool** |  | [optional] [default to True]
**cooling_type** | **str** |  | [optional] 
**exterior_type** | **str** |  | [optional] 
**fireplace** | **bool** |  | [optional] [default to True]
**fireplace_type** | **str** |  | [optional] 
**floor_count** | **int** |  | [optional] [default to 0]
**foundation_type** | **str** |  | [optional] 
**garage** | **bool** |  | [optional] [default to True]
**garage_spaces** | **int** |  | [optional] [default to 0]
**garage_type** | **str** |  | [optional] 
**heating** | **bool** |  | [optional] [default to True]
**heating_type** | **str** |  | [optional] 
**pool** | **bool** |  | [optional] [default to True]
**pool_type** | **str** |  | [optional] 
**roof_type** | **str** |  | [optional] 
**room_count** | **int** |  | [optional] [default to 0]
**unit_count** | **int** |  | [optional] [default to 0]
