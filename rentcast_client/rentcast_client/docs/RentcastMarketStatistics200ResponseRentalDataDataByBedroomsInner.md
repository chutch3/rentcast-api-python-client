...
rentcast_market_statistics200_response_rental_data_data_by_bedrooms_inner_instance = RentcastMarketStatistics200ResponseRentalDataDataByBedroomsInner.from_json(json)
# print the JSON string representation of the object
print(RentcastMarketStatistics200ResponseRentalDataDataByBedroomsInner.to_json())

# convert the object into a dict
rentcast_market_statistics200_response_rental_data_data_by_bedrooms_inner_dict = rentcast_market_statistics200_response_rental_data_data_by_bedrooms_inner_instance.to_dict()
# create an instance of RentcastMarketStatistics200ResponseRentalDataDataByBedroomsInner from a dict
rentcast_market_statistics200_response_rental_data_data_by_bedrooms_inner_from_dict = RentcastMarketStatistics200ResponseRentalDataDataByBedroomsInner.from_dict(rentcast_market_statistics200_response_rental_data_data_by_bedrooms_inner_dict)
```
