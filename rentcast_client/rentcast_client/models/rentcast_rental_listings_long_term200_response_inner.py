...
class RentcastRentalListingsLongTerm200ResponseInner(BaseModel):
    ...
    bathrooms: Optional[Union[StrictFloat, StrictInt]] = 0
    ...
    hoa: Optional[RentcastRentcastRentalListingsLongTerm200ResponseInnerHoa] = None
    ...
    listing_agent: Optional[RentcastRentcastRentalListingsLongTerm200ResponseInnerListingAgent] = Field(default=None, alias="listingAgent")
    listing_office: Optional[RentcastRentcastRentalListingsLongTerm200ResponseInnerListingOffice] = Field(default=None, alias="listingOffice")
    history: Optional[RentcastRentcastRentalListingsLongTerm200ResponseInnerHistory] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hoa": RentcastRentcastRentalListingsLongTerm200ResponseInnerHoa.from_dict(obj["hoa"]) if obj.get("hoa") is not None else None,
            ...
            "listingAgent": RentcastRentcastRentalListingsLongTerm200ResponseInnerListingAgent.from_dict(obj["listingAgent"]) if obj.get("listingAgent") is not None else None,
            "listingOffice": RentcastRentcastRentalListingsLongTerm200ResponseInnerListingOffice.from_dict(obj["listingOffice"]) if obj.get("listingOffice") is not None else None,
            "history": RentcastRentcastRentalListingsLongTerm200ResponseInnerHistory.from_dict(obj["history"]) if obj.get("history") is not None else None
        })
