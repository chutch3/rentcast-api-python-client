...
class RentcastMarketStatistics200ResponseSaleData(BaseModel):
    ...
    average_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="averagePrice", json_schema_extra={"examples": [356598]})
    median_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="medianPrice", json_schema_extra={"examples": [295000]})
    ...
    average_price_per_square_foot: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="averagePricePerSquareFoot", json_schema_extra={"examples": [203.45]})
    median_price_per_square_foot: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="medianPricePerSquareFoot", json_schema_extra={"examples": [188.61]})
    ...
    max_price_per_square_foot: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="maxPricePerSquareFoot", json_schema_extra={"examples": [943.24]})
    average_square_footage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="averageSquareFootage", json_schema_extra={"examples": [1717]})
    median_square_footage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="medianSquareFootage", json_schema_extra={"examples": [1573]})
    min_square_footage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="minSquareFootage", json_schema_extra={"examples": [636]})
    ...
    average_days_on_market: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="averageDaysOnMarket", json_schema_extra={"examples": [77]})
    ...
    max_days_on_market: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="maxDaysOnMarket", json_schema_extra={"examples": [279]})
    new_listings: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="newListings", json_schema_extra={"examples": [41]})
    total_listings: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalListings", json_schema_extra={"examples": [248]})
    ...
    history: Optional[RentcastMarketStatistics200ResponseSaleDataHistory] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "history": RentcastMarketStatistics200ResponseSaleDataHistory.from_dict(obj["history"]) if obj.get("history") is not None else None
        })
